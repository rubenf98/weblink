...
$('.list-item').click(function () {
    ...
    $(this).find('span').removeClass('fas fa-caret-down');
    item.find('span').addClass('fas fa-caret-right');
    //remover a seta para a direita no elemento que foi clicado
    $(this).find('span').removeClass('fas fa-caret-right');
    //adicionar a seta para baixo no elemento clicado
    $(this).find('span').addClass('fas fa-caret-down');
    //slide a todos up
    item.not(this).find('p').slideUp(100);
